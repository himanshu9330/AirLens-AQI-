...
const { getDashboardStats, getDashboardChartData, getNationalHotspots, getDetailedAlerts, getDetailedPredictions, getModelAccuracyMetrics, dispatchAlert } = require('../controllers/adminController');
...
router.get('/accuracy-metrics', protect, getModelAccuracyMetrics);
